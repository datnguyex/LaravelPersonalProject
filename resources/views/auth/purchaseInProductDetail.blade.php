    ...
    <div class="grid">
        <div class="grid__row app__contents">
            <div class="grid__column-12">
                            ...
                            <table class="table__product-payment" id="customers__payment">
                                ...
                                <tr class="product__cart-item">
                                    <td class="seller__td-img">
                                        ...
                                        <img src="{{ asset('img/img_auth/' . $product->img) }}" alt="" class="seller-img_product">
               ...
               <form action="{{ route('user.mailPurchaseProductDetail')}}" method="post">
                   @csrf
...
paymentMethodItem.forEach(element => {
    element.addEventListener('click', function() {
        // Set the shipMethod value to the innerHTML of the clicked element
        shipMethod.value = element.innerHTML;

        // Reset background and text color for all payment method items
        paymentMethodItem.forEach(item => {
            item.style.background = "white"; // Reset background color
            item.style.color = "black";      // Reset text color
        });

        // Set background and text color for the clicked element
